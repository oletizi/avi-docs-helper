...
public class HostDirectives {
  ...
  private final edu.uci.ics.crawler4j.robotstxt.RuleSet disallows = new edu.uci.ics.crawler4j.robotstxt.RuleSet();
  private final edu.uci.ics.crawler4j.robotstxt.RuleSet allows = new RuleSet();
