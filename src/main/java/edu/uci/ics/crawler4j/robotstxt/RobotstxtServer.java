...
public class RobotstxtServer {
  ...
  private static final Logger logger = LoggerFactory.getLogger(edu.uci.ics.crawler4j.robotstxt.RobotstxtServer.class);

  protected edu.uci.ics.crawler4j.robotstxt.RobotstxtConfig config;
