...
public class TLDList {
  ...
  private static final Logger logger = LoggerFactory.getLogger(edu.uci.ics.crawler4j.url.TLDList.class);

  private static boolean onlineUpdate = false;
  private final Set<String> tldSet = new HashSet<>(10000);

  private static final edu.uci.ics.crawler4j.url.TLDList instance = new edu.uci.ics.crawler4j.url.TLDList(); // Singleton
  ...
  public static edu.uci.ics.crawler4j.url.TLDList getInstance() {
    return instance;
  }
