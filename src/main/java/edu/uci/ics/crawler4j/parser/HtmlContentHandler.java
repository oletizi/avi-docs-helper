...
public class HtmlContentHandler extends DefaultHandler {
  ...
  private final List<edu.uci.ics.crawler4j.parser.ExtractedUrlAnchorPair> outgoingUrls;

  private edu.uci.ics.crawler4j.parser.ExtractedUrlAnchorPair curUrl = null;
  ...
  private void addToOutgoingUrls(String href, String tag) {
    curUrl = new edu.uci.ics.crawler4j.parser.ExtractedUrlAnchorPair();
    curUrl.setHref(href);
    curUrl.setTag(tag);
